...
Config.Strings = {
	ExitVehicle = "Descendez de votre vehicule pour mettre de l'essence.",
	EToRefuel = "~g~E ~w~pour mettre de l'essence",
	JerryCanEmpty = "Votre bidon d'essence est vide",
	FullTank = "vehicule plein d'essence",
	CancelFuelingPump = "~g~E ~w~pour stopper",
	CancelFuelingJerryCan = "~g~E ~w~pour stopper",
	RefillJerryCan = "~g~E ~w~ pour remplir votre bidon d'essence",
	JerryCanFull = "Votre bidon d'essence est remplie",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "~g~E ~w~pour recuperer un bidon d'essence"
	Config.Strings.RefillJerryCan = "~g~E ~w~ pour remplir votre bidon d'essence"
end
