...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
    ...
    local _UIMenu = {
        ...
        Banner = nil,
        Title = UIResText.New(Title, 0.5 + X, 0.5 + Y, 1.0, 255, 255, 255, 255, 0, 1, 0),
        BetterSize = true,
        Subtitle = { ExtraY = 0 },
        WidthOffset = 0,
        Position = { X = X, Y = Y },
    ...
    if Subtitle ~= "" and Subtitle ~= nil then
        ...
        _UIMenu.Subtitle.Text = UIResText.New(Subtitle, 8 + _UIMenu.Position.X, 110 + _UIMenu.Position.Y, 0.35, 245, 245, 245, 255, 1)
