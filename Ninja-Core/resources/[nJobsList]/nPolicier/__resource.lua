...
client_scripts {
    'utils/config.lua',
    'utils/peds.lua',
    'police_jobs/client_jobs/police_main.lua',
    'police_jobs/client_jobs/police_prison.lua',
    'police_jobs/client_jobs/police_vestiaire.lua',
    'police_jobs/client_jobs/police_armurie.lua',
    'police_jobs/client_jobs/police_garage.lua'
  }

  server_scripts {
    'utils/config.lua',
    '@mysql-async/lib/MySQL.lua',
    'police_jobs/server_jobs/police_main.lua'
  }